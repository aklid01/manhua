...
Natural US English for rendering, preserving register (tone directive). Outputs paraphrase.json.
"""
...
def run_paraphrase(workspace, config):
    """Run the Paraphrase stage over all pages in the workspace."""
    ws = Path(workspace)
    log_stage(logger, _STAGE_INDEX, _TOTAL_STAGES, _STAGE_NAME, "starting")

    # TODO: apply tone/register directive (keep crude characters crude).
    # TODO v0: manual JSON handoff; planned MCP / Ollama adapters.
